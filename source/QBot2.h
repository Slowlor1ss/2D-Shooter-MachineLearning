...
private:
	...
	int m_InputRotationIndex{0};
	int m_InputSpeedIndex{1};
	int m_InputEnemySeenIndex{2};
	int m_InputEnemyDistIndex{3};
	std::vector<int> m_InputObstacleProxIndices{4,5,6,7,8,9};
	std::vector<float> m_ObstacleSensorsInRad;

	int m_NrOfOutputs{ 3 }; // Actions

	int m_OutputRotationIndex{ 0 };
	int m_OutputSpeedIndex{ 0 };
	int m_OutputShootIndex{ 0 };
